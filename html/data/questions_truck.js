...
// LKW (truck) – 25 Fragen. Muss nach dem Boot-Snippet geladen werden, das window.MTJ_QUESTIONS initialisiert.
(function () {
  'use strict';
  ...
  window.MTJ_QUESTIONS.truck = [
    ...
    { text: "Lenk- und Ruhezeiten sind …", options: [
      { key: "correct", text: "Einzuhalten, Verstöße gefährden die Sicherheit" },
